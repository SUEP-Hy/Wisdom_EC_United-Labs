  ...
  <div class="container" >
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<kt-button :label="$t('action.search')" perms="sys:staffBiofeature:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
				<kt-button :label="$t('action.add')" perms="sys:staffBiofeature:add" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
	<kt-table permsEdit="sys:staffBiofeature:edit" permsDelete="sys:staffBiofeature:delete"
...
export default {
	...
	data() {
		return {
			...
			columns: [
				...
				{prop:"type", label:"生物类型", minWidth:100},
	...
	methods: {
		...
		findPage: function (data) {
			...
			this.$api.staffBiofeature.findPage(this.pageRequest).then((res) => {
				this.pageResult = res.data
			}).then(data!=null?data.callback:'')
		},
		// 批量删除
		handleDelete: function (data) {
			this.$api.staffBiofeature.batchDelete(data.params).then(data!=null?data.callback:'')
		},
		// 显示新增界面
		handleAdd: function () {
