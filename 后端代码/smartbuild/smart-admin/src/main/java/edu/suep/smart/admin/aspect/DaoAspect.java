package edu.suep.smart.admin.aspect;
...
import edu.suep.smart.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* edu.suep.smart.*.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* edu.suep.smart.*.dao.*.insert*(..))")
